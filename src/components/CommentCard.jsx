    ...
    <li className="flex gap-4">
      ...
      <div>
        <div className="flex items-center gap-2">
          <h4 className="text-xs md:text-sm text-label_color_tertiary">
        ...
        <span className="text-xs md:text-sm text-label_color_tertiary whitespace-pre-line">
          {data?.snippet?.topLevelComment?.snippet?.textOriginal}
        </span>
        <div className="flex gap-2 md:gap-4 mt-2 items-center">
          <img src={LikeIcon} alt="" className="w-3 h-3 md:w-4 md:h-4" />
